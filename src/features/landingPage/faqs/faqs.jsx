...
function Faqs() {
    return (
        <div className="Faqs_Container">
            <div className="Faqs_ContainerTitle">
                Have any doubts?
            </div>
            <h2 className="Faqs_ContainerSubTitle">
                Frequently asked questions
            </h2>
            <div className="Faqs_ContainerQuestionItemsContainer">
                {
                    faqsItem && faqsItem.map((item, key) => {
                        return <FaqCollapsible question={item.question} answer={item.answer} />
                    })
                }
            </div>
            {
